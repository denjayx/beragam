...
@section('content')
    <section class="bg-gray-100 dark:bg-gray-900 rounded-xl">
        <div class="mx-auto">
            <!-- Start coding here -->
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div
                    ...
                    <a href="{{ route('provinsi.create') }}" id="updateProductButton" data-modal-toggle="updateProductModal"
                            ...
                            @forelse ($provinsis as $provinsi)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        ...
                                        <img src="{{ asset('storage/provinsi/' . $provinsi->foto_url) }}" width="50"
                                            alt="Foto Provinsi {{ $provinsi->nama }}">
                                        <span>{{ $provinsi->nama }}</span>
                                    </th>
                                    <td class="max-w-xs px-4 py-3">
                                        {{ \Str::limit($provinsi->deskripsi, 60) }}
                                    </td>
