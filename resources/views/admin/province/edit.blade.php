@foreach ($provinces as $province)
    <!-- Main modal -->
    <div id="updateProductModal{{ $province->id }}" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="5"
                                ...
                                placeholder="Tuliskan deskripsi provinsis...">{{ old('deskripsi', $province->deskripsi) }}</textarea>
                            @error('deskripsi')
                                <span class="text-red-600">{{ $message }}</span>
                            @enderror
                        </div>
