    ...
    <div id="readProductModal{{ $culture->id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative max-w-2xl p-4 h-4/6">
            ...
            <div
                ...
                <dl>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Provinsi</dt>
                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $culture->provinces->nama }}
                    </dd>
                    <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Detail</dt>
                    <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">{{ $culture->deskripsi }}</dd>
                </dl>
            </div>
        </div>
    </div>
