...
@section('content')
    <section class="bg-gray-100 rounded-xl dark:bg-gray-900">
        <div class="mx-auto">
            <!-- Start coding here -->
            <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                ...
                <div
                    ...
                    <a href="{{ route('budaya.create') }}" id="updateProductButton" data-modal-toggle="updateProductModal"
                        ...
                        <tbody>
                            @forelse ($budayas as $budaya)
                                <tr class="border-b dark:border-gray-700">
                                    <th scope="row"
                                        class="flex items-center gap-2 px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <a href="">
                                            <img src="{{ asset('storage/budaya/' . $budaya->foto_url) }}" width="50"
                                                alt="Foto Provinsi {{ $budaya->provinsi->nama }}">
                                            <span>{{ $budaya->provinsi->nama }}</span>
                                        </a>
                                    </th>
                                    <td class="px-4 py-3">{{ $budaya->kategori->nama }}</td>
                                    <td class="px-4 py-3">{{ $budaya->nama }}</td>
                                    <td class="max-w-xs px-4 py-3">
                                        {{ Str::limit($budaya->deskripsi, 60) }}
                                    </td>
